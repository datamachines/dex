...
// ClientID represents minimal information about a client, e.g., for listing.
...
func (m *ClientID) GetPublic() bool {
	if m != nil {
		return m.Public
	}
	return false
...
func (m *ClientID) GetName() string {
	if m != nil {
		return m.Name
	}
	return ""
...
func (m *ClientID) GetLogoUrl() string {
	if m != nil {
		return m.LogoUrl
	}
	return ""
...
// ListClientsReq asks to list clients.
...
// ListClientsResp contains a list of ClientID.
type ListClientsResp struct {
	Clients              []*ClientID `protobuf:"bytes,1,rep,name=clients,proto3" json:"clients,omitempty"`
	XXX_NoUnkeyedLiteral struct{}    `json:"-"`
	XXX_unrecognized     []byte      `json:"-"`
	XXX_sizecache        int32       `json:"-"`
}
...
func (m *ListClientsResp) GetClients() []*ClientID {
	if m != nil {
		return m.Clients
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*ClientID)(nil), "api.ClientID")
	proto.RegisterType((*ListClientsReq)(nil), "api.ListClientsReq")
	proto.RegisterType((*ListClientsResp)(nil), "api.ListClientsResp")
...
var fileDescriptor_1b40cafcd4234784 = []byte{
	...
	,
}
...
func (*UnimplementedDexServer) ListClients(ctx context.Context, req *ListClientsReq) (*ListClientsResp, error) {
